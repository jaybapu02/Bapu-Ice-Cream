...
def seed_services(apps, schema_editor):
    ...
    services_data = [
        ...
        },
        {
            ...
            'full_description': 'Celebrate your birthday with Jay\'s Creamery! Our birthday party package includes a selection of premium ice creams, a custom ice cream cake, a toppings bar, and party favours. We can also personalize the menu to match your party theme. Available for kids and adults. Includes a dedicated server for the duration of your event.',
            'icon': 'bi-gift',
            'price': '3499',
            'is_featured': False,
            'is_popular': True,
        ...
        },
        {
            ...
            'full_description': 'Elevate your corporate events with Jay\'s Creamery catering. We cater to office parties, team-building events, client meetings, product launches, and company anniversaries. Choose from our curated corporate packages or build a custom menu. We offer contactless serving options and branded ice cream cups for a professional touch.',
            'icon': 'bi-briefcase',
            'price': '4999',
            'is_featured': False,
            'is_popular': False,
