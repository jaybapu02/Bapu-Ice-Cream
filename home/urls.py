...
urlpatterns = [
    ...
    path("catering/estimate/", views.CateringEstimateView.as_view(), name="catering_estimate"),
    ...
    path("cart/api/", views.CartAPIView.as_view(), name="cart_api"),
    ...
    path("payment/", views.CheckoutView.as_view(), name="payment"),
    path("payment/success/", views.RazorpayCallbackView.as_view(), name="payment_success"),
